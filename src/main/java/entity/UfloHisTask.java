...
public class UfloHisTask implements Serializable {
	 ...
	 * END_DATE_:
	 */
	@PropertyDef(label = "END_DATE_", description = "END_DATE_:")
	private Date endDate;

	/**
	 * HIS_PROCESS_INSTANCE_ID_:
	 */
	@PropertyDef(label = "HIS_PROCESS_INSTANCE_ID_", description = "HIS_PROCESS_INSTANCE_ID_:")
	 ...
	 * TASK_ID_:
	 */
	@PropertyDef(label = "TASK_ID_", description = "TASK_ID_:")
	private long taskId;
