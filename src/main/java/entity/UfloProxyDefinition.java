...
public class UfloProxyDefinition implements Serializable {
	 ...
	 * END_:
	 */
	@PropertyDef(label = "END_", description = "END_:")
	private Date end;

	/**
	 * IS_PROXY_ALL_:
	 */
	@PropertyDef(label = "IS_PROXY_ALL_", description = "IS_PROXY_ALL_:")
	private boolean isProxyAll;

	/**
	 * ISSUE_USER_:
	 */
	@PropertyDef(label = "ISSUE_USER_", description = "ISSUE_USER_:")
	private String issueUser;

	/**
	 * ISSUE_USER_CNAME_:
	 */
	@PropertyDef(label = "ISSUE_USER_CNAME_", description = "ISSUE_USER_CNAME_:")
	 ...
	 * START_:
	 */
	@PropertyDef(label = "START_", description = "START_:")
	private Date start;
