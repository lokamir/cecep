...
public class UfloTask implements Serializable {
	 ...
	 * NODE_NAME_:
	 */
	@PropertyDef(label = "NODE_NAME_", description = "NODE_NAME_:")
	 ...
	 * ASSIGNEE_:
	 */
	@PropertyDef(label = "ASSIGNEE_", description = "ASSIGNEE_:")
	private String assignee;

	/**
	 * BUSINESS_ID_:
	 */
	@PropertyDef(label = "BUSINESS_ID_", description = "BUSINESS_ID_:")
	private String businessId;

	/**
	 * COUNTERSIGN_COUNT_:
	 */
	@PropertyDef(label = "COUNTERSIGN_COUNT_", description = "COUNTERSIGN_COUNT_:")
	 ...
	 * DATE_UNIT_:
	 */
	@PropertyDef(label = "DATE_UNIT_", description = "DATE_UNIT_:")
	private String dateUnit;

	/**
	 * DUE_ACTION_DATE_:
	 */
	@PropertyDef(label = "DUE_ACTION_DATE_", description = "DUE_ACTION_DATE_:")
	private Date dueActionDate;

	/**
	 * DUEDATE_:
	 */
	@PropertyDef(label = "DUEDATE_", description = "DUEDATE_:")
	private Date duedate;

	/**
	 * OPINION_:
	 */
	@PropertyDef(label = "OPINION_", description = "OPINION_:")
	private String opinion;

	/**
	 * OWNER_:
	 */
	@PropertyDef(label = "OWNER_", description = "OWNER_:")
	private String owner;

	/**
	 * PREV_STATE_:
	 */
	@PropertyDef(label = "PREV_STATE_", description = "PREV_STATE_:")
	private String prevState;

	/**
	 * PREV_TASK_:
	 */
	@PropertyDef(label = "PREV_TASK_", description = "PREV_TASK_:")
	private String prevTask;

	/**
	 * PROCESS_INSTANCE_ID_:
	 */
	@PropertyDef(label = "PROCESS_INSTANCE_ID_", description = "PROCESS_INSTANCE_ID_:")
	private long processInstanceId;

	/**
	 * PROGRESS_:
	 */
	@PropertyDef(label = "PROGRESS_", description = "PROGRESS_:")
	private int progress;

	/**
	 * ROOT_PROCESS_INSTANCE_ID_:
	 */
	@PropertyDef(label = "ROOT_PROCESS_INSTANCE_ID_", description = "ROOT_PROCESS_INSTANCE_ID_:")
	private long rootProcessInstanceId;

	/**
	 * STATE_:
	 */
	@PropertyDef(label = "STATE_", description = "STATE_:")
	private String state;

	/**
	 * TASK_NAME_:
	 */
	@PropertyDef(label = "TASK_NAME_", description = "TASK_NAME_:")
