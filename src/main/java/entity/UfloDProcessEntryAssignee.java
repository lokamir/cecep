...
public class UfloDProcessEntryAssignee implements Serializable {
	 ...
	 * ASSIGNEE_ID_:
	 */
	@PropertyDef(label = "ASSIGNEE_ID_", description = "ASSIGNEE_ID_:")
	private String assigneeId;

	/**
	 * ASSIGNEE_NAME_ID_:
	 */
	@PropertyDef(label = "ASSIGNEE_NAME_ID_", description = "ASSIGNEE_NAME_ID_:")
	private String assigneeNameId;

	/**
	 * ASSIGNEE_PROVIDER_ID_:
	 */
	@PropertyDef(label = "ASSIGNEE_PROVIDER_ID_", description = "ASSIGNEE_PROVIDER_ID_:")
