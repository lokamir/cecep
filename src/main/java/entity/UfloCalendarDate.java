...
public class UfloCalendarDate implements Serializable {
	 ...
	 * CALENDAR_DATE_:
	 */
	@PropertyDef(label = "CALENDAR_DATE_", description = "CALENDAR_DATE_:")
	private Date calendarDate;

	/**
	 * CALENDAR_ID_:
	 */
	@PropertyDef(label = "CALENDAR_ID_", description = "CALENDAR_ID_:")
	private long calendarId;

	/**
	 * DAY_OF_MONTH_:
	 */
	@PropertyDef(label = "DAY_OF_MONTH_", description = "DAY_OF_MONTH_:")
	private int dayOfMonth;

	/**
	 * DAY_OF_WEEK_:
	 */
	@PropertyDef(label = "DAY_OF_WEEK_", description = "DAY_OF_WEEK_:")
	private int dayOfWeek;

	/**
	 * MONTH_OF_YEAR_:
	 */
	@PropertyDef(label = "MONTH_OF_YEAR_", description = "MONTH_OF_YEAR_:")
	 ...
	 * RANGE_END_TIME_:
	 */
	@PropertyDef(label = "RANGE_END_TIME_", description = "RANGE_END_TIME_:")
	private String rangeEndTime;

	/**
	 * RANGE_START_TIME_:
	 */
	@PropertyDef(label = "RANGE_START_TIME_", description = "RANGE_START_TIME_:")
