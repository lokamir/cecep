...
public class UfloProcessInstance implements Serializable {
	 ...
	 * CURRENT_NODE_:
	 */
	@PropertyDef(label = "CURRENT_NODE_", description = "CURRENT_NODE_:")
	private String currentNode;

	/**
	 * CURRENT_TASK_:
	 */
	@PropertyDef(label = "CURRENT_TASK_", description = "CURRENT_TASK_:")
	 ...
	 */
	@PropertyDef(label = "PARALLEL_INSTANCE_COUNT_", description = "PARALLEL_INSTANCE_COUNT_:")
	 ...
	 * PROMOTER_:
	 */
	@PropertyDef(label = "PROMOTER_", description = "PROMOTER_:")
	private String promoter;

	/**
	 * ROOT_ID_:
	 */
	@PropertyDef(label = "ROOT_ID_", description = "ROOT_ID_:")
	private long rootId;
	 ...
	 * TAG_:
	 */
	@PropertyDef(label = "TAG_", description = "TAG_:")
	private String tag;
