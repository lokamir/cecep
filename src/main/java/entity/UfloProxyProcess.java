...
public class UfloProxyProcess implements Serializable {
	 ...
	 * PROCESS_DEF_ID_:
	 */
	@PropertyDef(label = "PROCESS_DEF_ID_", description = "PROCESS_DEF_ID_:")
	private long processDefId;

	/**
	 * PROCESS_DEF_NAME_:
	 */
	@PropertyDef(label = "PROCESS_DEF_NAME_", description = "PROCESS_DEF_NAME_:")
	private String processDefName;

	/**
	 * PROXY_DEF_ID_:
	 */
	@PropertyDef(label = "PROXY_DEF_ID_", description = "PROXY_DEF_ID_:")
