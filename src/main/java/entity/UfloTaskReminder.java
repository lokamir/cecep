...
public class UfloTaskReminder implements Serializable {
	 ...
	 * CRON_:
	 */
	@PropertyDef(label = "CRON_", description = "CRON_:")
	private String cron;
	 ...
	 */
	@PropertyDef(label = "REMINDER_HANDLER_BEAN_", description = "REMINDER_HANDLER_BEAN_:")
	private String reminderHandlerBean;

	/**
	 * START_DATE_:
	 */
	@PropertyDef(label = "START_DATE_", description = "START_DATE_:")
	 ...
	 * TASK_NODE_NAME_:
	 */
	@PropertyDef(label = "TASK_NODE_NAME_", description = "TASK_NODE_NAME_:")
	private String taskNodeName;

	/**
	 * REMINDER_TYPE_:
	 */
	@PropertyDef(label = "REMINDER_TYPE_", description = "REMINDER_TYPE_:")
