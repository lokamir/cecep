...
public class UfloVariable implements Serializable {
	 ...
	 * BLOB_ID_:
	 */
	@PropertyDef(label = "BLOB_ID_", description = "BLOB_ID_:")
	private long blobId;

	/**
	 * BOOLEAN_VALUE_:
	 */
	@PropertyDef(label = "BOOLEAN_VALUE_", description = "BOOLEAN_VALUE_:")
	private boolean booleanValue;

	/**
	 * BYTE_VALUE_:
	 */
	@PropertyDef(label = "BYTE_VALUE_", description = "BYTE_VALUE_:")
	private byte byteValue;

	/**
	 * CHARACTER_VALUE_:
	 */
	@PropertyDef(label = "CHARACTER_VALUE_", description = "CHARACTER_VALUE_:")
	private String characterValue;

	/**
	 * DATE_VALUE_:
	 */
	@PropertyDef(label = "DATE_VALUE_", description = "DATE_VALUE_:")
	private Date dateValue;

	/**
	 * DOUBLE_VALUE_:
	 */
	@PropertyDef(label = "DOUBLE_VALUE_", description = "DOUBLE_VALUE_:")
	private double doubleValue;

	/**
	 * FLOAT_VALUE_:
	 */
	@PropertyDef(label = "FLOAT_VALUE_", description = "FLOAT_VALUE_:")
	private float floatValue;

	/**
	 * INTEGER_VALUE_:
	 */
	@PropertyDef(label = "INTEGER_VALUE_", description = "INTEGER_VALUE_:")
	private int integerValue;

	/**
	 * LONG_VALUE_:
	 */
	@PropertyDef(label = "LONG_VALUE_", description = "LONG_VALUE_:")
	private long longValue;

	/**
	 * SHORT_VALUE_:
	 */
	@PropertyDef(label = "SHORT_VALUE_", description = "SHORT_VALUE_:")
	private short shortValue;

	/**
	 * STRING_VALUE_:
	 */
	@PropertyDef(label = "STRING_VALUE_", description = "STRING_VALUE_:")
